                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            @if (session('status'))
                                    ...
                                    @endif
                                <form class="user" action="{{ route('profile_update', auth()->user()->id) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="form-group">
                                        <input name="name" type="text" class="form-control form-control-user"
                                            id="exampleInputName" aria-describedby="emailHelp"
                                            placeholder="Enter User Name..." value="{{ old('name', auth()->user()->name) }}">
                                    </div>
                                    <div class="form-group">
                                        <input name="address" type="text" class="form-control form-control-user"
                                            id="exampleInputName" aria-describedby="emailHelp"
                                            placeholder="Enter User Address..." value="{{ old('address', auth()->user()->address) }}">
                                    </div>
                                    <div class="form-group">
                                        <input name="email" type="email" class="form-control form-control-user"
                                            id="exampleInputEmail" aria-describedby="emailHelp"
                                            placeholder="Enter Email Address..." value="{{ old('email', auth()->user()->email) }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input name="repassword" type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Repassword" value="{{ old('repassword') }}">
                                    </div>
